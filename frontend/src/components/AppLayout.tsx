  ...
  return (
    <div className="min-h-screen text-slate-900">
      <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-[1600px] flex-col gap-3 px-5 py-3 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-2 lg:items-end">
            ...
            >
              {navItems.map((item) => (
                <NavLink
                  className={({ isActive }) =>
                    `shrink-0 rounded-lg px-3 py-2 text-sm font-semibold transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bms-blue ${
                      isActive
      ...
      <main className="mx-auto w-full max-w-[1600px] px-5 py-6 sm:px-8 sm:py-8">
        <Outlet />
      </main>

      <footer className="mx-auto w-full max-w-[1600px] px-5 pb-6 sm:px-8">
